...
export const OrderSummary: React.FC<OrderSummaryProps> = ({ 
  ...
  return (
    <div className="h-full bg-white flex flex-col font-sans text-gray-800">
      ...
      {activeTab === 'current' && (
        <div className="p-4 md:p-6 pt-0 space-y-3 pb-8 md:pb-6">
          ...
          <button className="w-full py-3 px-4 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-md text-sm font-medium transition-colors border border-gray-100">
            {t.review}
          </button>
